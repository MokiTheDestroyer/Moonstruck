...
public class Boss2Behaviour : MonoBehaviour {
	...
	void Fire(){
		...
		Vector3 startPosition1 = transform.position + new Vector3(0.5f, -0.6f, 0);
		...
		Vector3 startPosition2 = transform.position + new Vector3(1.5f, -0.6f, 0);
		...
		Vector3 startPosition3 = transform.position + new Vector3(-1.5f, -0.6f, 0);
		...
		Vector3 startPosition4 = transform.position + new Vector3(-0.5f, -0.6f, 0);
